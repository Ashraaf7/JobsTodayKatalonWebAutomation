...
String pathToChromeDriver = "C:\\Users\\elost\\.katalon\\packages\\Katalon_Studio_Windows_64-8.6.5\\configuration\\resources\\drivers\\edgechromium_win64\\msedgedriver.exe"
System.setProperty("webdriver.edge.driver", pathToChromeDriver)

// It is important that this chromeProfilePath ends with User Data and not with the profile folder (Profile 2)
String chromeProfilePath = "C:\\Users\\elost\\AppData\\Local\\Microsoft\\Edge\\User Data";
EdgeOptions edge = new EdgeOptions();
edge.setCapability("user-data-dir", chromeProfilePath)
// Here you specify the actual profile folder (Profile 2)
edge.setCapability("profile-directory","Default");
