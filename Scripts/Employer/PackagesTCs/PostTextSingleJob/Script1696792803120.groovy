...
WebUI.click(findTestObject('Object Repository/PostTextSingleJob/Page_/li_Text Job Posting'))
...
WebUI.click(findTestObject('Object Repository/PostTextSingleJob/Page_/button_Publish Now'))

WebUI.click(findTestObject('Object Repository/PostTextSingleJob/Page_/img'))

WebUI.click(findTestObject('Object Repository/PostTextSingleJob/Page_Jobstoday/span_My Jobs'))
